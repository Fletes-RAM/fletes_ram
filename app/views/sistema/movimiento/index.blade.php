...
@section('content')
  ...
  <style>
    ...
    .bank-card .small-box .inner {
      min-height: 95px;
    }

    .bank-card .small-box h3 {
      white-space: nowrap;
      font-size: 34px;
    }

    .bank-card .small-box p {
      min-height: 38px;
    }
  </style>
  ...
  <br><br>
    ...
    <div class="col-md-3">
      <div class="box box-success">
        ...
        <div class="box-body" align="center">
          <a href="{{ URL::route('newBancoMov') }}" class="btn btn-block btn-sq btn-success">
            <i class="fas fa-money-bill-alt fa-5x"></i><br>
            Agregar <br> Movimiento <br> Bancario
          </a>
        </div>
      </div>
    </div>
    ...
    <div class="col-md-3">
			<div class="box box-info">
				...
				<div class="box-body" align="center">
					<a href="{{ URL::route('newBancoPrest') }}" class="btn btn-block btn-sq btn-info">
  ...
  <div class="row">
    <div class="col-md-12">
      <div class="box box-info">
        <div class="box-header">
          <h3 class="box-title">
            <i class="fas fa-money-bill-alt"></i> Movimientos Bancarios
          </h3>
        </div>
            ...
            @foreach ($efectivos as $efectivo)
              <div class="col-md-3 bank-card">
                <div class="small-box bg-aqua">
                  ...
                  <a href="{{ URL::route('showBancoMov', $efectivo->id) }}" class="small-box-footer">
                ...
                @if ($currentUser->hasAccess('banco-especial'))
                  <div class="col-md-3 bank-card">
                    <div class="small-box bg-aqua">
                      ...
                      <a href="{{ URL::route('showBancoMov', $banco->id) }}" class="small-box-footer">
                        Detalle <i class="fas fa-arrow-circle-right"></i>
                      </a>
                    </div>
                  </div>
