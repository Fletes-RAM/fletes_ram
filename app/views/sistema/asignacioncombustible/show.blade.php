      ...
      <div class="panel panel-primary">
        <div class="panel-heading">
          <h3 class="panel-title">
            <div class="row">
              <div class="col-md-3">
                <i class="fas fa-info" data-fa-transform="shrink-3" data-fa-mask="fas fa-circle"></i> Folio:</br> N/A
              </div>
              <div class="col-md-3">
                <i class="fas fa-user" data-fa-transform="shrink-10 up-3 left-5" data-fa-mask="fas fa-truck"></i> Ruta</br> N/A
              </div>
              <div class="col-md-3">
                <i class="fas fa-address-book"></i> Cliente:</br> N/A
              </div>
              @if ($user->inGroup($admin))
                <div class="col-md-3">
                  <i class="fas fa-gas-pump"></i> Combustible Cotizado</br> N/A
                </div>
              @endif
            </div>
