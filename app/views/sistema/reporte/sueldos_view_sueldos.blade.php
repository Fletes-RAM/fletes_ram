          ...
          <table class="table table-striped table-bordered table-hover table-condensed">
            ...
            <tbody>
              @foreach ($controlesvehiculares as $controlvehicular)
                <tr>
                  ...
                  <td class="text-right">{{ number_format($controlvehicular->toneladas,2,'.',',') }}</td>
                  <td class="text-right">$ {{ number_format($controlvehicular->cantidad,2,'.',',') }}</td>
                  <td>% {{ $controlvehicular->porcentaje }}</td>
                  <td>% {{ $controlvehicular->iva * 100 }}</td>
                  <td class="text-right">$ {{ number_format($controlvehicular->cantidad * ($controlvehicular->porcentaje/100),2,'.',',') }}</td>
                </tr>
                <?php $total_controles = $total_controles + ($controlvehicular->cantidad * ($controlvehicular->porcentaje/100)); ?>
            ...
            <tfoot>
              <tr>
                ...
                <th></th>
                <th></th>
                <th style="color:green; text-align: right; font-size:20px;">Total Control Vehicular = <b>$ {{ number_format($total_controles, 2, '.', ',') }}</b></th>
              </tr>
          	</tfoot>
          </table>
        </td>
            ...
            <table class="table table-striped table-bordered table-hover table-condensed">
              ...
              <tbody>
                @foreach ($comprobantesvista as $comprobante)
                  <tr>
                    ...
                    <td class="text-right">$ {{ number_format($comprobante->precio,2,'.',',') }}</td>
              ...
              <tfoot>
                <tr>
                  ...
                  <th></th>
                  <th></th>
                  <th style="color:green; text-align: right; font-size:20px;">Total Comprobantes de Combustible = <b>$ {{ number_format($total_comprobantes, 2, '.', ',') }}</b></th>
                </tr>
            	</tfoot>
            </table>
          </div>
