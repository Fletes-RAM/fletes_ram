						...
						<tbody>
							@foreach ($sueldos as $sueldo)
								<tr>
									...
									<td align="center">
                    <a href="{{ URL::route('showSueldos', ['operador'=>$operador,'fecha1'=>$sueldo->fecha_inicio,'fecha2'=>$sueldo->fecha_fin]) }}" class="btn btn-sm btn-default" target="_blank"><i class="fas fa-money-bill-alt"></i> Detalle</a>
									</td>
								</tr>
							@endforeach
						</tbody>
